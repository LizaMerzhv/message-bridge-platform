...
public class NotificationIngestionListener {
  ...
  public NotificationIngestionListener(NotificationRepository notificationRepository, Clock clock) {
  ...
  @RabbitListener(
      queues =
          "${notifi.amqp.ingest-queue:"
              + com.example.notifi.common.messaging.AmqpConstants.INGEST_QUEUE
              + "}",
