...
public class WorkerProperties {
    ...
    public static class Amqp {
        ...
        private String ingestQueue = AmqpConstants.INGEST_QUEUE;
        private String tasksQueue = AmqpConstants.TASKS_QUEUE;
        private String retryQueue = AmqpConstants.RETRY_QUEUE;
        private String dlq = AmqpConstants.DLQ_QUEUE;

        private String ingestRoutingKey = AmqpConstants.INGEST_ROUTING_KEY;
        ...
        public void setIngestQueue(String ingestQueue) { this.ingestQueue = ingestQueue; }

        public String getTasksQueue() { return tasksQueue; }
        public void setTasksQueue(String tasksQueue) { this.tasksQueue = tasksQueue; }
        ...
        public void setIngestRoutingKey(String ingestRoutingKey) { this.ingestRoutingKey = ingestRoutingKey; }

        public String getTasksRoutingKey() { return tasksRoutingKey; }
        public void setTasksRoutingKey(String tasksRoutingKey) { this.tasksRoutingKey = tasksRoutingKey; }
