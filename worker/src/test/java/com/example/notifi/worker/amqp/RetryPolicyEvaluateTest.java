...
class RetryPolicyEvaluateTest {
    ...
    void computesMinDelayWithJitter() {
        ...
        assertThat(first.ttl()).isEqualTo(Duration.ofSeconds(24));
    ...
    private static class StubRandom implements DoubleSupplier {
        ...
        private StubRandom(AtomicReference<Double> value) { this.value = value; }
        @Override public double getAsDouble() { return value.get(); }
    }
}
