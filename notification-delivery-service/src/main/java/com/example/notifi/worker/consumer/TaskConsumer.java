...
public class TaskConsumer {
  ...
  private void notifyApi(
      NotificationEntity notification, NotificationStatus status, int attempt, Exception ex) {
    ...
    try {
      notificationApiClient.sendDeliveryResult(
          notification.getId(), status, reportedAttempt, clock.instant(), errorCode, errorMessage);
    } catch (Exception e) {
